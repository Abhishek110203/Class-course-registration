...
public class UpdateStudent {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(10, 0, 725, 88);
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(status==1) {
					...
					JOptionPane.showMessageDialog(null, "Problem In Updation");
				}
		...
		txtSerialNumber.setBounds(733, 31, 107, 33);
		frmAddStudentPage.getContentPane().add(txtSerialNumber);
		...
		btnNewButton_1.setBounds(876, 28, 115, 38);
